    ...
    public class Canvas {
        ...
        private JPanel SouthPanel () {
            ...
            ButBack.addActionListener(e -> {
                if (PressedBut.equals("PressedLine") || PressedBut.equals("PressedCircle") || PressedBut.equals("PressedRectangle") || PressedBut.equals("PressedTriangle")) {
                    SP.removeAll();
                    SP.add(ButLine);
                    SP.add(ButCircle);
                    SP.add(ButRectangle);
                ...
                if (PressedBut.equals("PressedArrayLines") || PressedBut.equals("PressedArrayCircles") || PressedBut.equals("PressedArrayRectangles") || PressedBut.equals("PressedArrayTriangles")) {
            ...
            ButCreate.addActionListener(e -> {
                ...
                if (PressedBut.equals("PressedLine")) {
                    ...
                    if (lines == null) {
                        ...
                        for (int i=0; i<5; i++) lines[i].Show(false);
                        for(int i=0; i<5; i++)
                        {
                            ch1 = (int) (Math.random() * 500);
                            ch2 = (int) (Math.random() * 500);
                    ...
                    if (rectangles == null) {
                        ...
                        for (int i = 0; i < 5; i++) rectangles[i].Show(false);
                        for (int i=0; i<5; i++) {
                            ch1 = (int) (Math.random() * 500);
                            ch2 = (int) (Math.random() * 500);
                            ch3 = (int) (Math.random() * 500);
